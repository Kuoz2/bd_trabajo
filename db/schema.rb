...
ActiveRecord::Schema.define(version: 2022_11_10_152402) do
  ...
  create_table "binnacles", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "producto", default: 0
    t.bigint "categoria", default: 0
    t.bigint "stock", default: 0
    t.bigint "marca", default: 0
  end
  ...
  create_table "codes", force: :cascade do |t|
    ...
    t.string "pcodigo"
    t.bigint "total_doble", default: 0
  end
